...
class Difference {
  constructor(oldOfficer, newOfficer, items) {
    try {
      ...
      this.oldItems = Array.from(this.oldOfficer.querySelectorAll(items));
      this.newItems = Array.from(this.newOfficer.querySelectorAll(items));
      this.oldCounter = 0;
      this.newCounter = 0;
    } catch (e) {}
  }
...
class Download {
  constructor(triggers) {
    ...
    this.path = 'assets/img/mainbg.js';
  }
  downloadItem(path) {
